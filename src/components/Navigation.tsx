...
export default function UserNavigation({ session }: UserNavigationProp) {
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              >
                <MenuItem>
                  <>
                    <div className='block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 border-b'>{session?.firstName}</div>
                    <a
                      href="#"
                      onClick={(e) => {
                        e.preventDefault();
