...
const Navbar = () => {
  ...
  return (
    <>
      {/* Side Navigation */}
      <div className={`fixed z-[999] w-full lg:w-max inset-0 bg-black/20 ml-[-1px] ${isOpen ? "left-0" : "-left-full"} lg:left-0`} onClick={() => setIsOpen(false)}>
                    ...
                    <li key={item.name} className="flex items-center space-x-4">
                      <Link
                        ...
                        className={classNames(
                          pathname === item.href ? 'text-white font-bold' : 'text-gray-400  hover:text-white hover:font-bold whitespace-nowrap transition-all duration-300',
